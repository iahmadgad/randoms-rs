...
fn main()
{
    ...
    let temperature: f64 = temperature.trim().parse().expect("Error parsing tempareture");
    ...
    match unit
    {
	'c' => println!("{temperature} celsius is {} fahrenheit", celsius_to_fahrenheit(temperature)),
	'f' => println!("{temperature} fahrenheit is {} celsius", fahrenheit_to_celsius(temperature)),
